...
| Command | Result |
|---|---|
| `/bin/zsh scripts/verify.sh all` | Repository portability gate plus 165 tests pass; native app and CLI release build pass; clean committed runs also execute the fresh-clone gate |
