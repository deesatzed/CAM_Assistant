...
| CAM-013 | Daily-use wiki and local-model chat | In progress | Library source detail/citation navigation complete; raw-source lifecycle, packaged journey, and selected local-model cited synthesis remain |
