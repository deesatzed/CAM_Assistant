...
| CAM-015 | Persistent repository intelligence | In progress | Restart-safe jobs, non-destructive removal, frozen semantic evaluation, strict loopback generation, citation-free abstention, CLI, and evidence-complete card conversion pass; named model failures are preserved, while a valid passing pre-registered semantic-support contract, native live-repository journey, broader intake, and live typed coordination remain |
