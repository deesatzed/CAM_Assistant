...
| CAM-012 | UX and packaging | In progress | Packaged hotkey, watched-source, accessible ingest cancel/restart/resume, selected-model, package/smoke, and fresh-clone foundations pass; backup/restore, complete accessibility, and final aggregate proof remain |
