...
| Command | Result |
|---|---|
| `/bin/zsh scripts/verify.sh all` | 156 tests pass; native app and CLI release build pass |
...
| Usability, evidence, release | Native chat/capture surface, local task promotion, empty/offline/accessibility labels, Carbon registration status in the running packaged app, and local package/smoke scripts | Partial: no end-to-end global-hotkey action proof, reduced-motion/UI automation proof, signed/notarized distribution, or full user journey verification |
