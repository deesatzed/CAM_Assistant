...
| 2026-07-30 | MeaningCore is pinned only as a local-development library dependency at `23db68044ebdc410edf3b7f436e433ffba6e94b8`. Because the pinned repository has no explicit license or distribution grant, packaged Meaning Preview distribution and all later pilot implementation are stopped pending a compatible grant; no license may be inferred from public repository access | Active |
