...
| `Tests/ReleaseProofTests/verify-release-privacy-suite-tests.sh` | Scanner clean/failure/redaction contracts pass; release package and saved evidence scan passes with 40 files and zero credential-signature findings; atomic JSON receipt saved |
