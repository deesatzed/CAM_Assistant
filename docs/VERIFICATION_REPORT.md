...
| `/bin/zsh scripts/verify.sh fresh-clone` | Temporary non-local clone of durable CAM runtime-state checkpoint `0528cb8aca357504d2292fbf4bf876878c20c76a` passes portability, the honest 48-gate map, all 312 tests, app/CLI release builds, package reproducibility (`e2707e1c1f948551004a8a949011dce89e12a629a04520b1e1568fd93f0c1830`), package identity with `dirty=false`, a 56-file zero-finding credential-signature scan, and offline smoke from a clean source tree |
