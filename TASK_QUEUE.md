...
| CAM-013 | Daily-use wiki and local-model chat | In progress | Library detail/navigation and typed loopback local-model cited synthesis are complete; raw-source lifecycle, packaged live-model journey, and frozen generated-claim faithfulness/latency evaluation remain |
